...
public class JwtUtil {
    ...
    public static String generateAccessToken(String email, Map<String, Object> userInfo) {
    ...
    public static JWTClaimsSet validToken(String token) throws ParseException, JOSEException {
        SignedJWT signed = SignedJWT.parse(token);
        JWSVerifier verifier = new MACVerifier(SECRET_KEY);
        Date expirationTime = signed.getJWTClaimsSet().getExpirationTime();
        if(!signed.verify(verifier) || !expirationTime.after(new Date())) return null;
